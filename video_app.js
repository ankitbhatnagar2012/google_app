...
/**
 * Confirms whether user wants to add a video to the course content
 * @param {String} videoId  The video Id to be added.
 */
ytVideoApp.myAddEntry = function(videoId) {
  // sample youtube link - http://www.youtube.com/watch?v=videoId  
  alert('Add the following lines to your content to embed this video :-\n\n[media|640|480]http://www.youtube.com/watch?v='+ videoId +'[/media]');
}
